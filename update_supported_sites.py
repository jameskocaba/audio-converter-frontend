...
PLATFORMS_TO_TEST = {
    ...
    # --- Audio & Music ---
    "SoundCloud": {"desc": "Individual tracks, mixes, and public playlists.", "url": "https://soundcloud.com/coleschotz/cole-schotz-sound-check", "skip_test": True}, # Forced to always show as active
